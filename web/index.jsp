<html>
    <head>
        ...
        <style>
            ...
            .imgslider{
                ...
                box-shadow: 1px 2px 10px 5px lightskyblue;
            ...
            .card{
                box-shadow: 0 4px 8px 0 rgba(12,5,0,0.6);
                transition: 0.4s;
                width: 300px;
                height: 100px;
                background: #fefbd8;
    ...
    <body>
        ...
        <footer>
              ...
              <div class="center box">
                ...
                <div class="content">
                  <div class="place">
                    ...
                    <span class="text">Lucknow, Uttar Pradesh</span>
                  </div>
                  <div class="phone">
                    <span class="fas fa-phone-alt"></span>
                    <span class="text">+068-675234985</span>
                  </div>
                  <div class="email">
                    <span class="fas fa-envelope"></span>
                    <span class="text">pqr@bank.com</span>
                  </div>
                </div>
              </div>
            ...
            <div class="bottom">
              <center>
                <span class="credit">Created By <a href="index.jsp">Ankit Rai</a> | </span>
